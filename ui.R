    ...
    dashboardSidebar(
      sidebarMenu(id = "sidebarmenu", ### create a menu in the sidebar
          ...
          fluidPage(
             ...
             sliderInput(inputId = "size2",label = "Size",min = 0,max = 5,value = 0.4,step = 0.1)
          ...
          conditionalPanel("input.sidebarmenu === 'spatial2'",
             ...
             sliderInput(inputId = "sizespatial2",label = "Size",min = 0,max = 5,value = 0.4,step = 0.1),
          ...
          conditionalPanel("input.sidebarmenu === 'CODEXspatialexpression'",
                           fluidPage(
                             ...
                             radioButtons(inputId="maximize_differences", label="Maximize differences (only for RNA)", 
                                            choices = c("Yes" = "yes",
                                                        "No" = "no"),selected = "No"),
                             ...
                             conditionalPanel(
                               ...
                               sliderInput(inputId="mincoCODEXspatial", label="Minimum cutoff (only for RNA)", min = 0,max=1,value=0,step=0.01) ),
    ...
    dashboardBody(
      tabItems(
        tabItem(tabName = "fileupload",
                fluidRow(plotOutput ("p1", height = 500)
        ...
        tabItem(tabName = "UMAPIndSamples",
                fluidRow(plotOutput ("p5", height = 500)
        ...
        tabItem(tabName = "spatial2",
                fluidRow(plotOutput ("p4", height = 500)
        ...
        tabItem(tabName = "DEsTabandUMaps",
                ...
                fluidRow(plotOutput ("p6", height = 500)
        ...
        tabItem(tabName = "CODEXUMAPclusters",
                fluidRow(plotOutput ("p19", height = 500)
        ...
        tabItem(tabName = "CODEXindep",
                fluidRow(plotOutput ("p20", height = 500)
                ) #Closing the fluid Row of CITE independent
        ), # Closing tabItem of CITE independent     
        
        
        tabItem(tabName = "AdjacencybyFeature",
                        fluidRow(plotOutput ("p15", height = 500)
                        ), #Closing the fluid Row of the adjacency heatmap by feature
                        br(),
                        fluidRow(plotOutput ("p16", height = 500)
        ...
        tabItem(tabName = "AdjacencybyCluster",
                        fluidRow(plotOutput ("p17", height = 500)
                        ), #Closing the fluid Row of the adjacency heatmap by feature
                        br(),
                        fluidRow(plotOutput ("p18", height = 500)
                        ), #Closing the fluid Row of the Pearson correlation
                        br(),
